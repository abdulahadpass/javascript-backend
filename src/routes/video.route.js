...
import { createUserVideo, deleteUserVideo, getAllVideo, getVideo, toggleAvideo, updatedUserVideo } from "../controllers/video.controller.js";
...
router.route("/toggle/publish/:videoId").patch(verifyJwt, verifyVideo , toggleAvideo);
